...
/** Read the raw PWM duty cycle value of a motor.
 * @param Motor The motor to read the speed from.
 * @param Direction The motor direction to read the speed from.
 * @return The raw PWM duty cycle value.
 */
